...
@time begin # Measure the computation time
    ...
    # Import 151x81 approximate solution in Fourier coefficients for SB
    u = load("useq_c12.jld2", "uNewton")

    ucoeff = reshape(coefficients(u), 151, 81)
